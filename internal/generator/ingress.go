	...
	if err == nil {
		...
		for idx, service := range buildValues.Services {
			...
			if service.AutogeneratedRoutesEnabled {
				...
				oauthEnabled := helpers.BoolPtr(true)
				if buildValues.LagoonYAML.Routes.Autogenerate.OauthProtected != nil {
					oauthEnabled = buildValues.LagoonYAML.Routes.Autogenerate.OauthProtected
				} 
